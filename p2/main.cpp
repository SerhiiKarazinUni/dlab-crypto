...
static void shift_bits(uint8_t *array, int len, int shift) {
    bool left = false;
...
int main() {
    biguint numberA = biguint("FFFFFFFFFFFFFFFF0000000000000000");
    biguint numberB = biguint("FF0000FF00000000000000FF00000000");
    cout<<"getHex:\n";
    ...
    cout<<"should be      : 00ffff00ffffffff000000ff00000000\n\n";

    cout<<"OR:\n";
    cout<<"numberA|numberB: "<<(numberA|numberB)<<"\n";
    cout<<"should be      : ffffffffffffffff000000ff00000000\n\n";

    cout<<"AND:\n";
    cout<<"numberA&numberB: "<<(numberA&numberB)<<"\n";
    cout<<"should be      : ff0000ff000000000000000000000000\n\n";
